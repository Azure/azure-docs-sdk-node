...
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/maps-search_2.0.0-alpha.20250210.1/sdk/maps/maps-search-rest/samples)
...
You can authenticate with Microsoft Entra ID using the [Azure Identity library](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/maps-search_2.0.0-alpha.20250210.1/sdk/identity/identity). To use the [DefaultAzureCredential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/maps-search_2.0.0-alpha.20250210.1/sdk/identity/identity#defaultazurecredential) provider shown below, or other credential providers provided with the Azure SDK, please install the `@azure/identity` package:
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/maps-search_2.0.0-alpha.20250210.1/sdk/core/logger).
