...
ms.service: maps
---
# Azure Maps Common client library for JavaScript - version 1.0.0-alpha.20250109.2 
/TypeScript
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/maps-common_1.0.0-alpha.20250109.2/CONTRIBUTING.md) to learn more about how to build and test the code.
