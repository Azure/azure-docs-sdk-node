...
ms.service: synapse
---
## Azure Synapse Access Control REST client library for JavaScript - version 1.0.0-alpha.20250107.1 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/synapse-access-control_1.0.0-alpha.20250107.1/SUPPORT.md) for more details.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/synapse-access-control_1.0.0-alpha.20250107.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[rest_client]: https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/synapse-access-control_1.0.0-alpha.20250107.1/documentation/rest-clients.md
