---
title: Azure DashboardManagement client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-dashboard, dashboard
ms.date: 02/07/2025
ms.topic: reference
ms.devlang: javascript
ms.service: dashboard
---
# Azure DashboardManagement client library for JavaScript - version 1.1.1-alpha.20250206.1 
...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-dashboard_1.1.1-alpha.20250206.1/sdk/dashboard/arm-dashboard) |
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-dashboard_1.1.1-alpha.20250206.1/SUPPORT.md) for more details.
...
You can authenticate with Azure Active Directory using a credential from the [@azure/identity][azure_identity] library or [an existing AAD Token](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-dashboard_1.1.1-alpha.20250206.1/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-with-a-pre-fetched-access-token).
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-dashboard_1.1.1-alpha.20250206.1/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-dashboard_1.1.1-alpha.20250206.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-dashboard_1.1.1-alpha.20250206.1/sdk/identity/identity
[defaultazurecredential]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-dashboard_1.1.1-alpha.20250206.1/sdk/identity/identity#defaultazurecredential
