...
---
# Azure Web PubSub service client library for JavaScript - version 1.1.4-alpha.20250107.1 
...
[Source code](https://github.com/Azure/azure-sdk-for-js/blob/@azure/web-pubsub_1.1.4-alpha.20250107.1/sdk/web-pubsub/web-pubsub) |
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/web-pubsub_1.1.4-alpha.20250107.1/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/web-pubsub_1.1.4-alpha.20250107.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[samples_ref]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/web-pubsub_1.1.4-alpha.20250107.1/sdk/web-pubsub/web-pubsub/samples
