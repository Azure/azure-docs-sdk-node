...
---
# Azure Load Testing client library for JavaScript - version 1.0.1-alpha.20250107.1 
...
**Please rely heavily on our [REST client docs](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/load-testing_1.0.1-alpha.20250107.1/documentation/rest-clients.md) to use this library**
...
To use an [Azure Active Directory (AAD) token credential](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-with-a-pre-fetched-access-token),
provide an instance of the desired credential type obtained from the
[@azure/identity](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/identity/identity#credentials) library.

To authenticate with AAD, you must first `npm` install [`@azure/identity`](https://www.npmjs.com/package/@azure/identity)

After setup, you can choose which type of [credential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/identity/identity#credentials) from `@azure/identity` to use.
As an example, [DefaultAzureCredential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/identity/identity#defaultazurecredential)
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/core/logger).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/load-testing_1.0.1-alpha.20250107.1/CONTRIBUTING.md).
...
[source_code]: https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/loadtesting/load-testing-rest/src
[sample_code]: https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/load-testing_1.0.1-alpha.20250107.1/sdk/loadtesting/load-testing-rest/samples/v1-beta
