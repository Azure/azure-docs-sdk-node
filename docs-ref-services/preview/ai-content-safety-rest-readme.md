...
---
# Azure AI Content Safety REST client library for JavaScript - version 1.0.1-alpha.20250205.1 
...
**Please rely heavily on our [REST client docs](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/documentation/rest-clients.md) to use this library**

Key links:

- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/sdk/contentsafety/ai-content-safety-rest)
...
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/sdk/contentsafety/ai-content-safety-rest/samples)
...
To authenticate with AAD, you must first `npm` install [`@azure/identity`](https://www.npmjs.com/package/@azure/identity). After setup, you can choose which type of [credential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/sdk/identity/identity#credentials) from `@azure/identity` to use.
As an example, [DefaultAzureCredential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/sdk/identity/identity#defaultazurecredential)
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/ai-content-safety_1.0.1-alpha.20250205.1/CONTRIBUTING.md) to learn more about how to build and test the code.
