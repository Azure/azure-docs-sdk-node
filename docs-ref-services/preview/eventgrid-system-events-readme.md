...
---
# Azure Event Grid Namespaces client library for JavaScript - version 1.0.0-alpha.20250110.1 
...
- [Source code](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid-system-events_1.0.0-alpha.20250110.1/sdk/eventgrid/eventgrid-system-events/)
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid-system-events_1.0.0-alpha.20250110.1/SUPPORT.md) for more details.
...
For more detailed instructions on how to enable the logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid-system-events_1.0.0-alpha.20250110.1/sdk/core/logger).

## Contributing

If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid-system-events_1.0.0-alpha.20250110.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure-core-tracing-github]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid-system-events_1.0.0-alpha.20250110.1/sdk/core/core-tracing
