...
keywords: Azure, javascript, SDK, API, @azure/arm-migrationdiscoverysap, migrationdiscovery
ms.date: 02/11/2025
ms.topic: reference
ms.devlang: javascript
ms.service: migrationdiscovery
---
# Azure Workloads client library for JavaScript - version 1.0.0-alpha.20250211.1 
...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/sdk/migrationdiscovery/arm-migrationdiscoverysap) |
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/SUPPORT.md) for more details.

### Prerequisites

- An [Azure subscription][azure_sub].

### Install the `@azure/arm-migrationdiscoverysap` package
...
You can authenticate with Azure Active Directory using a credential from the [@azure/identity][azure_identity] library or [an existing AAD Token](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-with-a-pre-fetched-access-token).
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/sdk/identity/identity
[defaultazurecredential]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-migrationdiscoverysap_1.0.0-alpha.20250211.1/sdk/identity/identity#defaultazurecredential
