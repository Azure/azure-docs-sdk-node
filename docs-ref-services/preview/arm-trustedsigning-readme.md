---
title: Azure CodeSigningManagement client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-trustedsigning, trustedsigning
ms.date: 01/07/2025
ms.topic: reference
ms.devlang: javascript
ms.service: trustedsigning
---
# Azure CodeSigningManagement client library for JavaScript - version 1.0.0-alpha.20250107.1 
...
[API reference documentation](/javascript/api/@azure/arm-trustedsigning?view=azure-node-preview) |
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/SUPPORT.md) for more details.
...
You can authenticate with Azure Active Directory using a credential from the [@azure/identity][azure_identity] library or [an existing AAD Token](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-with-a-pre-fetched-access-token).
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/sdk/core/logger).


## Contributing

If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/sdk/identity/identity
[defaultazurecredential]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-trustedsigning_1.0.0-alpha.20250107.1/sdk/identity/identity#defaultazurecredential
