...
---
# Azure Communication Chat client library for JavaScript - version 1.5.5-alpha.20250205.1 
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/communication-chat_1.5.5-alpha.20250205.1/CONTRIBUTING.md) to learn more about how to build and test the code.
