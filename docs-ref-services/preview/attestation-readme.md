...
---
# Azure Attestation client library for JavaScript - version 1.0.1-alpha.20250212.1 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/attestation_1.0.1-alpha.20250212.1/SUPPORT.md) for more details.
...
For more information about the Azure Identity APIs and how to use them, see [Azure Identity client library](https://github.com/Azure/azure-sdk-for-js/tree/@azure/attestation_1.0.1-alpha.20250212.1/sdk/identity/identity)
...
Most Attestation service operations will raise exceptions defined in [Azure Core](https://github.com/Azure/azure-sdk-for-js/blob/@azure/attestation_1.0.1-alpha.20250212.1/sdk/core/README.md). The attestation service APIs will throw a `RestError` on failure with helpful error codes. Many of these errors are recoverable.
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/attestation_1.0.1-alpha.20250212.1/sdk/core/logger).
...
[source_code]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/attestation_1.0.1-alpha.20250212.1/sdk/attestation/attestation
...
[contributing]: https://github.com/Azure/azure-sdk-for-js/blob/@azure/attestation_1.0.1-alpha.20250212.1/CONTRIBUTING.md
