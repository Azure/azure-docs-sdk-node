...
[Source code](https://github.com/Azure/azure-sdk-for-js/blob/@azure/api-management-custom-widgets-scaffolder_1.0.0-alpha.20250210.1/sdk/apimanagement/api-management-custom-widgets-scaffolder/) |
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/api-management-custom-widgets-scaffolder_1.0.0-alpha.20250210.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
View our [tests](https://github.com/Azure/azure-sdk-for-js/blob/@azure/api-management-custom-widgets-scaffolder_1.0.0-alpha.20250210.1/sdk/apimanagement/api-management-custom-widgets-scaffolder/test)
