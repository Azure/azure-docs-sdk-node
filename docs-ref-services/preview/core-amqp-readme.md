...
ms.service: core
---
# Azure Core AMQP client library for JavaScript - version 4.3.5-alpha.20250110.2 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/core-amqp_4.3.5-alpha.20250110.2/SUPPORT.md) for more details.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/core-amqp_4.3.5-alpha.20250110.2/CONTRIBUTING.md) to learn more about how to build and test the code.
