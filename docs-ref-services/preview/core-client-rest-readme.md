...
ms.service: core
---
# Azure Rest Core client library for JavaScript - version 2.3.4-alpha.20250210.2 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/core-client_2.3.4-alpha.20250210.2/SUPPORT.md) for more details.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/core-client_2.3.4-alpha.20250210.2/CONTRIBUTING.md) to learn more about how to build and test the code.
