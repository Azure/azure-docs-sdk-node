---
title: 
keywords: Azure, javascript, SDK, API, @typespec/ts-http-runtime, core
ms.date: 02/13/2025
ms.topic: reference
...
This is the runtime dependency of packages generated by `@azure-tools/typespec-ts`. It is intended to be a cloud-agnostic library for facilitating HTTP requests at runtime.
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.1.0/SUPPORT.md) for more details.
...
Most policies only concern themselves with either the request or the response, but there are some exceptions such as the [LogPolicy](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.1.0/sdk/core/ts-http-runtime/src/policies/logPolicy.ts) which logs information from each.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.1.0/CONTRIBUTING.md) to learn more about how to build and test the code.
